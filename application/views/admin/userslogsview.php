		...
		<div id='page'>
			<p class="ui-widget-header" title="PageAreaTitleBar">
				...
				<span id="columnActivators">
					...
					<input type="checkbox" title='l_adminUsername'  checked="checked" id="check3"/><label for="check3">Admin</label>
					<input type="checkbox" title='l_action'  checked="checked" id="check4" /><label for="check4">Action</label>
					<input type="checkbox" title='l_user'  checked="checked" id="check5" /><label for="check5">User</label>
					<!--input type="checkbox" title='l_value' checked="checked" id="check7"/><label for="check7">Team</label-->
				</span>
			...
			<table id="columnList">
				<tr>  
					...
					<th class='l_adminUsername'>Admin</th>
					<th class='l_action'>Action</th>
					<th class='l_user'>User</th>
					<!--th class='l_value'>Team</th-->
				</tr>
				<?php 
					echo $usersLog;
				?>
